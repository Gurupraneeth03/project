...
const translations: Record<Language, Record<string, string>> = {
  ...
  te: {
    ...
    applyForFunding: "రుణానికి దరఖ���స్తు చేయండి",
    ...
    transparentTC: "పారదర్శక రుణ నిబంధనల�� మరియు సేంద్రీయ తగ్గింపు ప్రయోజనాలు",
    ...
    returnsDescription: "సాంప్రదాయిక వడ్డీకి బదులుగా, పెట్టుబడిదారులు వారు మద్దతు చేసిన రైతులు పెంచిన తాజా సేంద్రీయ ఉత్పత్తులపై విలువై��� తగ్గింపులు పొందుతారు.",
    ...
    aboutUsIntro: "అగ్రోఫైనా అనేది ధనవంతులైన పెట్టుబడిదారులను అవసరంలో ఉన్న సేంద్రీయ రైత��లతో ప్రత్యేకమైన రుణ-నుండి-తగ్గింపు మోడల్ ద్వారా కలిపే వినూత్న వేదిక, స���థిరమైన వ్యవసాయం మరియు ఆరోగ్యకరమైన రిటర్న్‌లను సృష్టిస్తుంది.",
    ...
    equalAccessForAllFarmers: "అన్ని నేపథ్యాలు మరియు వ్యవసాయ ప���ిమాణాల రైత��లకు సమాన రుణ అవకాశాలు",
    ...
    investmentGrowthTracking: "రుణ పోర్ట్‌ఫోలియో మరియు ర���తు మద్దతు ట్రా���ింగ్",
    discountBenefitsOverview: "సేంద్రీయ ఉత్పత్తి తగ్గింపు ప్రయోజనాల అవ��ోకనం",
    ...
    howItWorksDetailDescription: "పెట్టుబడిదారులు ��ైతులకు రుణాలు ఎ��ా అందిస్తారు మరియు సాంప్రదాయిక వడ్డీకి బదులుగా సేంద్రీయ ఉత్పత్తి తగ్గింపులు ఎలా పొందుతారు అనే వివరణాత్మక వివరణ.",
    ...
    investorsProvidesLoanDesc: "పెట్టుబడిదారులు అవసరంలో ఉన్న రైతు��� దరఖాస్తులను చూసి పంట రకం, భూమి పరిమాణం మరియు ని���ుల అవసరాల ఆధారంగ��� రుణాలు అందిస్తారు",
    ...
    maintainOrganicStandards: "ధ��వీకృత సేంద్రీయ ప్ర��ాణాలను నిర్వహించండి",
    ...
    howToGetStarted: "ఎలా ప్రారంభిం��ాలి",
    ...
    specifyCropRequirements: "వ్యవసాయ ప్రణాళికతో మీ పంట రకం, భూమి ప్రాంతం మరియు ��వసరమైన రుణ మొత్తాన్ని పేర్���ొనండి",
    ...
    purpose: "ఉద్దేశ్యం",
    applyForSeasonalLoan: "మీ పంట సాగుకు మద్దతు ఇవ్వడానిక��� కాలానుగుణ రుణానికి దరఖాస్తు చేయండి",
    ...
    copyright: "© 2024 అగ్రోఫైనా. అన్ని హక్కుల�� రిజర్వ్ చేయబడ్డాయి.",
    ...
    testimonial1Text: "అగ్రోఫైనా ద్వారా సేంద్రీయ రైతులకు రుణాలు అందించడం చాలా బహుమతిగా ఉంది. నగదు రిటర్న్స్‌కు బదులుగా, నా కుటుంబం ఇష్టపడే తాజా సేంద్రీయ ఉత్పత్తులపై అద్భుతమైన తగ్గింపులు పొందుతున్నాను. ఇది ��ద్దేశ్యంతో పెట్టుబడి పెట్���డం!",
    ...
    trackFarmingJourney: "మీ వ���యవసాయ ప్రయాణం మరియు కోత రికార్డులను ట్రాక్ చేయండి",
