...
const translations: Record<Language, Record<string, string>> = {
  ...
  te: {
    ...
    howItWorksDescription: "మా వేదిక ధనవంతులైన పెట్టుబడిదారులను అవసరంల��� ఉన్న రైతులతో వినూత్న రుణ-నుండి-తగ్గింపు మోడల్ ద్వారా కలుపుతుంది.",
    ...
    aboutDescription: "స్థిరమైన వ��యవసాయం కోసం ధనవంతులైన పెట్టుబడిదారులను అవసరంలో ఉన్న సేంద్రీయ రైతులతో కలిపే మా మిషన్ గురించి తెలుసుకోండి.",
    ...
    farmersDashboardDesc: "రుణ దరఖాస్తులు, తిరిగి చెల���లింపు స్థితి, పంట ప్రగతిని ట్రాక్ చేయండి మరియు మద్దతు చేసే పెట్టుబడిదారులతో కనెక్ట్ అవండి.",
    ...
    // Mission
    ourMission: "మా మిషన్",
    missionStatement: "ధనవంతులైన పెట్టుబడిదారులు రుణాల ద్వారా అవసరంలో ఉన్న సేంద్రీయ రైతులను మద్దతు చేసే స్థిరమైన పర్యావరణ వ్యవస్థను సృష్టించడం, ప్రతిఫలంగా ఆరోగ్యకరమైన సేంద్రీయ ఉత్పత్తి తగ్గింపులు పొందడం, కమ్యూ��ిటీ వెల్‌నెస్ మరియు వ్యవసాయ శ్రేయస్సును పెంపొందించడం.",
    ...
    contactDescription: "మా రుణ-నుండి-తగ్గింపు వేదిక గురించి మద్దతు, భాగస్వామ్�� అవకాశాలు లేదా సాధారణ విచారణల కోసం మా బృందంతో సంప్రదించండి.",
    ...
    contactForm: "దిగువ ఫారమ్ పూరించండి మరియు మేము వీలైనం�� త్వరగా మీకు తిరిగి సందేశం పంపుతాము",
    name: "పేరు",
    message: "సందేశం",
    ...
    ourLoanToDiscountModel: "మా రుణ-నుండి-తగ్గి��పు మోడల్",
    ...
    provideLoanWithoutInterest: "సాంప్రదాయిక వడ��డీ లేకుండా రుణం అందించండి",
    ...
    investorReceivesDiscounts: "పెట్టుబడిదారు���ు సేంద్రీయ తగ్గింపులు పొందుతాడు",
    ...
    supportNeedyFarmers: "మీ కుటుంబా��ికి అర్ధవంతమైన ఆరోగ్య ప్రయోజనాలు పొందుతూ అవసరంలో ఉన్న రైతులను మద్దతు చేయండి",
    ...
    trackSupportedFarmers: "మీరు మద్దతు చేసిన రైతులు మరి���ు పంట పురోగతిని నిజ-సమయంలో ట్రాక్ చేయండి",
    ...
    buildRelationships: "మీ విజయ�� గురించి శ్రద్ధ వహించే మద్దతు చేసే పెట్టుబడిదారులతో సంబంధాలను నిర్మించండి",
    ...
    browseFarmerApplications: "రైతుల దర��ాస్తులను బ్రౌజ్ చేయండి",
    ...
    registerYourFarm: "మీ వ్య���సాయాన్ని నమోదు చేసుకోండి",
    ...
    farmerDashboardDescription: "��ీ పంట, భూమి పరిమాణం మరియు నిధుల అవసరాలను పేర్కొంటూ సేంద్రీయ వ్యవసాయ రుణాలకు దరఖాస్తు చేసుకోండి.",
    ...
    applyForNewLoan: "కొత్త రుణ��నికి దరఖాస్తు చేయండి",
    ...
    totalInvestment: "మొత్తం పెట్టు��డి",
    land: "భూమి",
    ...
    testimonialsDescription: "రుణాలు అందించే పెట్టుబడిదారులు మరియు మద్దతు పొ���దే రైతుల నుండి నిజమైన అనుభవాలు",
    ...
    testimonial2Text: "అగ్రోఫైనా ద్వారా రుణం పొందడం నా వ్యవసాయాన్ని మార్చేసింది. సంక్లిష్టమైన EMI ఒత్తిడి లేదు - కేవలం నాణ్యమైన సేంద్రీయ పంటలు పెంచడంపై దృష్టి. నా మద్దతు చేసే పెట్టుబడిదారులు నా వ్యవసాయాన్ని సందర్��ించి ఉత్పత్తి నాణ్యతను మెచ్చుకుంటారు!",
