...
const translations: Record<Language, Record<string, string>> = {
  ...
  te: {
    ...
    heroDescription: "ధనవంతు��ైన పెట్టుబడిదారులను అవసరంలో ఉన్న సేంద్రీయ రైతులతో కలపండి. పెట్టుబడిదారులు పంట సాగుకు రుణాలు అందించి, సాంప్రదాయిక వడ్డీకి బదులుగా తాజా సేంద్రీయ ఉత్పత్తులపై తగ్గింపులు పొందుతారు.",
    ...
    aboutDescription: "స్థిరమైన వ్యవసాయం కోసం ధనవంతులైన పెట్టుబడిదారులను అవసరంలో ఉన్న ��ేంద్రీయ రైతులతో కలిపే మా మిషన్ గురించి తెలుసుకోండి.",
    ...
    inclusiveInvestmentDesc: "ధనవంతులైన పెట్టుబడిదారులు వ్యవసాయ పరిమాణంతో సంబంధం లేకుండా అవసరంలో ఉన్న రైతులకు రుణాలు అందిస్తారు, స్థిరమైన సేంద్రీయ వ్యవసాయ అభివృద్ధికి సమాన ప్��ాప్యతను నిర్ధారిస్తారు.",
    ...
    farmersDashboardDesc: "రుణ దరఖాస్తులు, తిరిగి చెల్లింపు స్థితి, పంట ప్రగతిని ట్రాక్ చేయండి మరియు మద్దతు ���ేసే పెట్టుబడిదారులతో కనెక్ట్ అవండి.",
    ...
    farmerDashboardDescription: "మీ పంట, భూమి పరి���ాణం మరియు నిధుల అవసరాలను పేర్కొంటూ సేంద్రీయ వ్యవసాయ రుణాలకు దరఖాస్తు చేసుకోండి.",
    ...
    investorFromMumbai: "ముంబై నుండి రుణ అందించే���ారు",
