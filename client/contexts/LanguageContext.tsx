...
const translations: Record<Language, Record<string, string>> = {
  ...
  te: {
    ...
    returnsDescription: "సాంప్రదాయిక వడ్డీకి బదులుగా, పెట్టుబడిదారులు వారు మద్దతు చేసిన రైతులు పెంచిన తాజా సేంద్రీయ ఉత్పత్తులపై విలువైన తగ్��ింపులు పొందుతారు.",
    ...
    // Core Features
    inclusiveInvestment: "సమన్విత���ైన రుణ పంపిణీ",
    ...
    healthyReturnsDesc: "సాంప్రదాయిక వడ్డీ చెల్లింపులకు బదులుగా, పెట్టుబడ���దారులు వారు మద్దతు చేసిన రైతులు పెంచిన తాజా సేంద్రీయ ఉత్పత్తులపై గణనీయమైన తగ్గింపులు పొందుతారు, ఆరోగ్యకరమైన జీవనాన్ని ప్రోత్సహిస్తుంది.",
    ...
    phasedSustainableDevelopment: "స్థిరమైన సేంద్రీయ వ్యవసాయ పద్ధతులను ప్రోత్సహించే కాల��నుగుణ ఆర్థిక మద్దతు",
    ...
    howItWorksDetailDescription: "పెట్టుబడిదారులు రైతులకు రుణాలు ఎలా అందిస్తారు మరియు సాంప���రదాయిక వడ్డీకి బదులుగా సేంద్రీయ ఉత్పత్తి తగ్గింపులు ఎలా పొందుతారు అనే వివరణాత్మక వివరణ.",
    ...
    whyThisModelWorks: "ఈ ��ోడల్ ఎందుకు పని చేస్తుంది",
    ...
    valueEquivalentReturns: "సేంద్రీయ ఆహార ఆ��ా ద్వారా సాంప్రదాయిక రిటర్న్‌లకు సమానమైన విలువను పొందండి",
    ...
    noComplexEMI: "సంక్లిష్టమైన EMI షె���్యూల్‌లు లేవు - నాణ్యమైన సేంద్రీయ పంటలు పెంచడంపై దృష్టి పెట్టండి",
    ...
    registerYourAccount: "మీ ఖాతాను నమోదు చేసుకోండ���",
    ...
    noActiveLoans: "క్రియాశీల రుణాలు లేవు",
    activeLoanAmount: "క్రియాశీ��� రుణ మొత్తం",
    ...
    testimonial1Text: "అగ్రోఫైనా ద్వారా సేంద్రీయ రైతులకు రుణాలు అందించడం చాలా బహుమతిగా ఉంది. నగదు రిటర్న్స్‌కు బదులుగా, నా కుటుంబం ఇష్టపడే తాజా సేంద్రీయ ఉత్పత్తులపై అద్భుతమైన తగ్గింపులు పొందుతున్నాను. ఇది ఉద్దేశ���యంతో పెట్టుబడి పెట్టడం!",
    testimonial2Text: "అగ్రోఫైనా ద్వారా రుణం పొందడం నా వ్యవసాయాన��ని మార్చేసింది. సంక్లిష్టమైన EMI ఒత్తిడి లేదు - కేవలం నాణ్యమైన సేంద్రీయ పంటలు పెంచడంపై దృష్టి. నా మద్దతు చేసే పెట్టుబడిదారులు నా వ్యవసాయాన్ని సందర్శించి ఉత్పత్తి నాణ్యతను మెచ్చుకుంటారు!",
