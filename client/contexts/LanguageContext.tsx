...
const translations: Record<Language, Record<string, string>> = {
  ...
  te: {
    ...
    returnsDescription: "సాంప్రదాయిక వడ్డీకి బదులుగా, పెట్టుబడిదారులు వారు మద్దతు చేసిన రైతులు పెంచిన తాజా సేంద్రీయ ఉత్పత్తులపై విల��వైన తగ్గింపులు పొందుతారు.",
    ...
    transparentDashboardsDesc: "రుణ స్థితి, పంట ప్రగతి మరియు సేంద్రీయ ఉత్పత్తి తగ్గింపు ప్రయోజనాలను ట్రాక్ చేయడానికి పె��్టుబడిదారులు మరియు రైతుల కోసం స్పష్టమైన డ్యాష్‌బోర్డ్‌లు.",
    ...
    phasedSustainableDevelopment: "స్థిరమైన సేంద్రీయ వ్యవసాయ పద్ధతులను ప్రోత్సహ��ంచే కాలానుగుణ ఆర్థిక మద్దతు",
    ...
    howItWorksDetailDescription: "పెట్టుబడిదారులు రైతులకు రుణాలు ఎలా అందిస్తారు మర���యు సాంప్రదాయిక వడ్డీకి బదులుగా సేంద్రీయ ఉత్పత్తి తగ్గింపులు ఎలా పొందుతారు అనే వివరణాత్మక వివరణ.",
    ...
    maintainOrganicStandards: "ధృవీకృత సేంద్రీయ ప్రమాణాలను నిర్వహించండ��",
    ...
    noComplexEMI: "సంక్లిష్��మైన EMI షెడ్యూల్‌లు లేవు - నాణ్యమైన సేంద్రీయ పంటలు పెంచడంపై దృష్టి పెట్టండి",
    ...
    getLoanApproval: "మా వేదిక ద్వారా మద్దతు చేసే పెట్టుబడిదారుల నుండి రుణ ఆమోదం మరియు నిధులు పొందం��ి",
    ...
    copyright: "© 2024 అగ్రోఫైనా. అన్ని హక్క���లు రిజర్వ్ చేయబడ్డాయి.",
