...
const translations: Record<Language, Record<string, string>> = {
  ...
  te: {
    ...
    heroDescription: "ధనవంతులైన పెట్టుబడిదారులను అవసరంలో ఉన్న సేంద్రీయ రైతులతో కలప���డి. పెట్టుబడిదారులు పంట సాగుకు రుణాలు అందించి, సాంప్రదాయిక వడ్డీకి బదులుగా తాజా సేంద్రీయ ఉత్పత్తులపై తగ్��ింపులు పొందుతారు.",
    ...
    investmentProcessDescription: "ధనవంతులైన పెట్టుబడిదారులు మా సురక్షిత వేదిక ద్వారా అవసరంలో ఉన్న రై���ులకు రు���ాలు అందిస్తారు, సేంద్రీయ వ్యవసాయ అభివృద్ధికి మద్దతు ఇస్తారు.",
    ...
    aboutDescription: "స్థిరమైన వ్యవసాయం కోసం ధనవంతులైన పెట్టుబడిదారులను అవసరంలో ఉన్న సేంద్రీయ రైతులతో కలిపే మా మిషన్ గురించి తెలుసుక���ండి.",
    ...
    phasedDisbursement: "కాలానుగు��� రుణ నిర్మాణం",
    ...
    languageAccessibilityDesc: "ఇంగ్లీష్ మరియు తెలుగు భాషలకు ప���ర్తి మద్దతు, మా రుణ-నుండి-తగ్గింపు వేదికను వివిధ ప్రాంతాలలోని పెట్టుబడిదారులు మరియు రైతులకు అందుబాటులో ఉంచుతుంది.",
    ...
    // Why Choose Us
    whyChooseUs: "మా వేదికను ఎందుక��� ఎంచుకోవాలి?",
    ...
    simpleThreeStepProcess: "ధనవంతులైన పెట్టుబడిదారులు, అవసరంలో ఉన్న రైతులకు ప్రయోజనం చేకూర్చే మరియు సేంద్రీయ వ్యవసాయాన్ని ప్రోత్��హించే సరళమైన 3-దశల ప్రక్రియ",
    wealthyInvestorProvidesLoan: "ధనవంతుడైన పెట్టుబడిదారుడు రుణం అందిస్తాడు",
    investorsProvidesLoanDesc: "పెట్టుబడిదారులు అవసరంలో ఉన్న రైతు��� దరఖాస్తులను చూసి పంట రకం, భూమి పరిమాణం మరియు నిధుల అవసరాల ఆధారంగ��� రుణాలు అందిస్తారు",
    ...
    farmerGrowsDesc: "అవసరంలో ఉన్న రైతు��ు రుణాన్ని ఉపయోగించి సేంద్రీయ పంటలను సాగు చేస్తారు, న���ణ్యత మరియు స్థిరమైన వ్యవసాయ పద్ధతులపై దృష్టి సారిస్తారు",
    ...
    investorReceivesDesc: "సాంప్రదాయిక వడ్డీకి బదులుగా, పెట్టుబడిదారులు మద్దతు చేసిన రైతుల నుండి తాజా సేంద్రీయ ఉత్పత్తులపై గ��నీయమైన తగ్గింపులు పొందుతారు",
    ...
    supportNeedyFarmers: "మీ కుటుంబానికి అర్ధవంతమైన ఆరోగ్య ప్రయోజనాలు పొందుతూ అవసరంలో ��న్న రైతులను మద్దతు చేయండి",
    ...
    buildRelationships: "మీ విజయం గురించి శ్రద్ధ వహించే మద్దతు చేసే పెట్టుబడి��ారులతో సంబంధాలను నిర్మించండి",
    ...
    selectFarmersSupport: "మద్దతు చేయడానికి రైతులను ఎంచుకోండి మరియు మా సురక్షిత వేదిక ద్వారా రుణాలు అందించండ��",
    ...
    provideDetailsFarmer: "��ధార్, వ్యవసాయ ప్రాంతం, భూమి పరిమాణం మరియు వ్యవసాయ రకంతో సహా మీ వివరాలను అందించండి",
    ...
    applyForFarmingLoan: "వ్యవసాయ రుణ��నికి దరఖాస్తు చేయండి",
    ...
    testimonial3Text: "అవసరంలో ఉన్న రైతులను మద్దతు చేస్తూ ఆరోగ్యకరమైన సేంద్రీయ కూరగ���యలు మరియు పండ్లపై గణనీయమైన తగ్గింపులు పొందడం నాకు ఇష్టం. నా పెట్టుబడి కుటుంబాలకు సహాయపడుతుంది మరియు నా స్వంత కుటుంబాన్ని ఆరోగ్యంగా ఉంచుతుంది. పర్ఫెక్ట్ విన���-విన్ మోడల్!",
    ...
    totalBorrowed: "మొత్తం అమ్మేసినది",
